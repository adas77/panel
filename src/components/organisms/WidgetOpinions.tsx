...
const WidgetOpinions = (props: Props) => {
    ...
    const rev = currentReview >= 4 ? lang.veryGood : currentReview >= 3 ? lang.satisfiedCustomers : lang.unhappy
    const num = currentReview.toPrecision(2).toString() + " / 5.0"
    ...
    return (
        <>
            ...
            </>} title={lang.opinions} tags={[num, rev]} href={'/opinions'} tagsIncolumn />
        </>
    )
}
